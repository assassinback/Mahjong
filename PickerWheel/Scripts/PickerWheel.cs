...
namespace EasyUI.PickerWheelUI {
   ...
   public class PickerWheel : MonoBehaviour {
      ...
      [SerializeField] public GameObject linesParent ;

      [Space]
      [SerializeField] public Transform PickerWheelTransform ;
      [SerializeField] public Transform wheelCircle ;
      [SerializeField] public GameObject wheelPiecePrefab ;
      [SerializeField] public Transform wheelPiecesParent ;

      [Space]
      [Header ("Sounds :")]
      [SerializeField] public AudioSource audioSource ;
      [SerializeField] public AudioClip tickAudioClip ;
      ...
      private void DrawPiece (int index) {
         ...
         //Line
         GameObject temp = Instantiate(linePrefab, linesParent.transform.position, Quaternion.identity);
            temp.transform.SetParent(linesParent.transform);
            temp.SetActive(false);
/*         Transform lineTrns = temp.transform;
